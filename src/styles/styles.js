const styles = {
    ...
    heading: 'text-[27px] text-center md:text-start font-[600] font-Baskerville pb-[20px]',
    ...
    shop_name:"pt-3 text-[15px] text-green-600 pb-3",
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-[#153448] rounded-full ", 
    button: 'w-[150px] bg-[#153448] h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer hover:scale-110',
