...
const DashboardHero = () => {
  ...
  const handleInquiryClick = async () => {
    ...
    const inquiryData = {
        ...
        const response = await axios.post(`${server}/mail/send-inquiry/seller`, inquiryData);
  ...
  return (
    <div className="w-full h-full mx-8 pt-10 mb-1">
      ...
      <div className="w-full block 800px:flex items-center gap-4">
          ...
          <div className="flex items-start">
            {/* <AiOutlineMoneyCollect
              ...
              <div className="flex flex-col items-start">
                ...
                <h5 className="text-[32px] font-[400] text-[#3C5B6F]">{products && products.length}</h5>
              </div>
          </div>
          <div className="">
            <Link to="/dashboard-products">
              <h5 className="text-[#077f9c] mx-auto w-full text-center pr-2">View All Products</h5>
            </Link>
          </div>
        </div>
        ...
        <div className="w-full mb-4 800px:w-[40%] min-h-[20vh] rounded px-2 py-5 ">
          <div className="flex items-start ">
            ...
            <div className="flex flex-col items-start">
              <h3 className={`${styles.productTitle} !text-[16px] tracking-tighter font-sans leading-5 !font-[700] mt-2 text-[#3C5B6F]`}>QUERY RELATED TO DASHBOARD</h3>
              <h5 className="text-[32px] font-[400] text-[#3C5B6F] tracking-wider">Contact Us</h5>
            </div>
      ...
      <br />
      <h3 className="text-[32px] font-600 text-[#3C5B6F] font-Poppins pb-2">GST Verification</h3>
