...
function ProductCard({ product }) {
  ...
  return (
    <div className="md:w-1/2 max-lg:w-1/2 p-2 max-md:w-full ">
          ...
          <div className="flex flex-col justify-between w-full mt-4 ml-0 md:mt-0 md:w-1/2 md:ml-5">
            ...
            <div className="flex flex-col mt-2">
              ...
              <div className="flex gap-3 items-center">
                ...
                <div className=" rounded-md p-2 animate-pulse">
                  {/* Price Card */}
...
const Categories = () => {
  ...
  const mobileView = (window.innerWidth >= 768 && window.innerWidth < 1024);
  ...
  return (
    ...
    >
      <div className="flex flex-col w-full ">
        <header className="flex flex-wrap items-center justify-between max-sm:justify-center w-full mb-5 md:flex-nowrap">
          <h1 className="mb-3 text-3xl  max-sm:text-2xl font-bold text-[#153448] md:mb-0 md:text-4xl">
            Live rate of yarn
          </h1>
          ...
          <div className="flex gap-3 max-sm:hidden">
            <button
              type="button"
              className={`flex items-center text-white justify-center w-12 h-12 p-2 border-2 border-solid rounded-full ${
            ...
            <button
              type="button"
              className={`flex items-center justify-center text-white w-12 h-12 p-2 border-2 border-solid rounded-full ${
                !isGridView ? "border-teal-900 bg-white" : "bg-[#153448] "
              }`}
              onClick={nextSlide}
        ...
        <section className="mt-5">
          ...
          <div
            className={`flex flex-wrap ${isGridView ? "-mx-2" : ""} justify-center `}
          ...
          >
            ...
            {visibleProducts.map((product, index) => (
              // <div className="transition-transform duration-300 transform lg:hover:scale-110">
              // </div>
              // <div className={`${mobileView ? "w-[500vw]":null}`}>
                <ProductCard key={index} product={product} className={`${mobileView ? "w-[50vw]":null}`} />
              // </div>
