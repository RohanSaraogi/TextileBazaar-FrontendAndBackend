...
const App = () => {
  ...
  async function getStripeApikey() {
    const { data } = await axios.get(`${server}/sub/stripeapikey`);
  ...
  useEffect(() => {
    ...
    Store.dispatch(fetchAllSubscriptionDetails());
    getStripeApikey();
  }, []);
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/contactus" element={<ContactSection14 />} />
        <Route path="/pricing" element={<Membershiproute />} />
